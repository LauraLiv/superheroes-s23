const superheroes = [
  ...
  },
  {
    ...
    image: "https://billeder.jyllands-posten.dk/4XMD1ujeo_Ig_OmQyI52bLfwiXP1RC11SrTgDE5lGqI/resize:fill:940:0:0/plain/https%3A%2F%2Fbilleder.jyllands-posten.dk%2Fpictures%2Fimage%2F9704104%2Fe2yax2%2FALTERNATES%2Fmaster-3_2%2Ffilm-review-spider-man-homecoming",
  },
  {
    name: "spiderman",
...
function showSuperheroes(superhero) {
  const template = document.querySelector("template").content;
  const clone = template.cloneNode(true);
  clone.querySelector(".name").textContent = superhero.name;
  clone.querySelector(".good").textContent = superhero.good;
  clone.querySelector(".power").textContent = superhero.power;
  clone.querySelector(".height").textContent = superhero.height;
  clone.querySelector(".day").textContent = superhero.dob.day;
  clone.querySelector(".month").textContent = superhero.dob.month;
  clone.querySelector(".year").textContent = superhero.dob.year;
  clone.querySelector(".image").src = superhero.image;
